...
if __name__ == '__main__':
    ...
    data_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'processed', 'spotify_conversations.csv')
    if not os.path.exists(data_path):
        print(f"Processed data not found at {data_path}")
        print("Run the pandas pipeline first: python -m src.pipelines.pandas_pipeline")
        exit(1)
    ...
    save_intent_taxonomy(taxonomy, output_dir)
