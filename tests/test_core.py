...
class TestDataValidation:
    ...
    def test_required_columns(self):
        from src.data.validation import validate_schema, REQUIRED_COLUMNS
...
class TestConversationBuilder:
    ...
    def test_clean_text(self):
        from src.data.conversation_builder import clean_text
    ...
    def test_extract_mention(self):
        from src.data.conversation_builder import extract_mention
...
class TestPipelineSelector:
    ...
    def test_select_pandas(self):
        from src.pipelines.pipeline_selector import select_pipeline
...
class TestBaselines:
    ...
    def test_trivial_baseline(self):
        from src.evaluation.baselines import TrivialBaseline
